...
app.use(express.static(__dirname + "/LastApp/dist"));
...
app.post('/create', function(req, res){
    ...
    mov.save(function(err, result){
        ...
        //     console.log(result);
        //     res.json({message: "Add rest", data: result});
        // }
    });
});
...
app.all('*', (req, res, next) => {
    res.sendFile(path.resolve('./LastApp/dist/index.html'));
});
